...
class CustomDataset(Dataset):
    def __init__(self, root_dir, gaussian_dir, target_dir, transform=None):
        ...
        for subdir in sorted(os.listdir(root_dir)):
            ...
            if os.path.isdir(subdir_path) and os.path.isdir(gaussian_subdir_path_1) and os.path.isdir(gaussian_subdir_path_2) and os.path.isdir(gaussian_subdir_path_3) and os.path.isdir(target_subdir_path):
...
def main():
    ...
    dataset = CustomDataset(sharp_images_dir, gaussian_dir, downscaled_dir, transform)
    ...
    # Save checkpoint
    prepare_submission(model, './deblur_checkpoint.pth')
